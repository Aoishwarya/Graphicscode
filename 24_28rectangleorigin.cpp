...
void translation()
{
int tx,ty,xn1,yn1,xn2,yn2;int x1,y1,x2,y2,midx,midy;
...
void scaling()
{
float xn1,yn1,xn2,yn2;int x1,y1,x2,y2,midx,midy;
float sx,sy;
...
void rotation()
{
int ang;int x1,y1,x2,y2,midx,midy;
...
void shearing()
{
float sh;int x1,y1,x2,y2,midx,midy;
